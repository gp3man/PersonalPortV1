...
const NavBar = () => {
  ...
  return (
    <section
      id="NavBar"
      className="fixed mb-6 top-0 left-0 right-0 h-[58px] w-screen p-4 z-40 flex flex-row opacity-90 dark:opacity-80 bg-blue-800 dark:bg-gray-900 text-slate-300  dark:text-slate-100 shadow justify-around"
    >
