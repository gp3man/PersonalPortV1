  ...
  return (
    <section id="AboutMe">
      ...
      <h3>
        ...
        dreams! I have now graduated my web development boot camp. I seek a path
        to create technologies that will impact and advance the human experience
        on this floating rock we all share.
      </h3>
    </section>
  );
};
